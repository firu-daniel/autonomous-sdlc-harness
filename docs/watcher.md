...
| `parked` | the run wrote an unanswered clarification question and yielded | `/autonomous-sdlc-harness:branch-answer` writes the paired `answer_<n>.md`; the park-resume pass re-launches the same engine in the same working copy |
