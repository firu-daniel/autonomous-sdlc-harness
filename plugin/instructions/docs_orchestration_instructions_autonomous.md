...
The canonical loop for `/branch-start-docs-autonomous`. You are the **orchestrator**: you dispatch `docs-writer` / `docs-reviewer`, flip checklist boxes, and commit. You never write or review a doc yourself.
