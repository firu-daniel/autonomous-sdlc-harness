...
6. For a **parked** run, point the user at `/autonomous-sdlc-harness:branch-answer` (and the question path) as the next action; for a **completed** run, note `/autonomous-sdlc-harness:branch-user-review` is how to start a fix round.
