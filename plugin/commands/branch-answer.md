...
This command writes one answer file and reports; it never takes the clear action itself. It must NOT modify `<scripts_dir>/autonomous-watcher.sh`, the engines, or the instruction forks.
