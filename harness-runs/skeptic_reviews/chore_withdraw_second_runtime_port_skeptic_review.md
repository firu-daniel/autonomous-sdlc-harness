...
2. [x] **Finding 1** — State in §4 that each run's phase total is a lower bound, because the selector drops the session where planning converged _(layer: general)_
