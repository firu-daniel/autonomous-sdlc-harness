...
1. [ ] **Finding 1** — Add `### The maintainer's decision` after `### The verdict` in `docs/retrieval-eval-results.md`, with the four reasons, leaving the verdict, figures and rule untouched. _(layer: general)_
