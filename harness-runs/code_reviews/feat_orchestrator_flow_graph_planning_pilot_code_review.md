...
5. [x] **Finding 4** — Cite the planning core as `${CLAUDE_PLUGIN_ROOT}/…` in the shipped graph's `description`, and in its mirror and fixture copies _(layer: cli, general)_
