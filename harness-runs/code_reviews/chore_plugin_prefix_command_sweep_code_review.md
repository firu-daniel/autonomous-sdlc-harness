...
5. [x] **Finding 3** — Qualify the README's "every command in this tree is documented with the plugin prefix" by pointing at gate 6's carve-outs _(layer: general)_
