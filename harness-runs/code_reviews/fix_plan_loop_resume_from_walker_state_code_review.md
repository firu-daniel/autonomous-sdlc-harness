...
3. [x] **Finding 3** — Widen `## Setup` step 5's trigger to a decision that weighs a saved walk _(layer: plugin)_
4. [x] **Finding 1** — Append pending answered pairs when a continued walk re-dispatches a writer _(layer: plugin)_
