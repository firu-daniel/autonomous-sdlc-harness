...
2. [x] **Task 2** — Record the quoting requirement as a measured manifest fact in `docs/development.md` and run the acceptance checks _(layer: general)_ _(points: 10)_
