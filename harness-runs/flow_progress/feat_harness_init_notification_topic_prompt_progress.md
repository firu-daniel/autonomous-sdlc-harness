# Flow progress — feat_harness_init_notification_topic_prompt   (engine: task)

## Run mode
Source: harness-runs/task_prompts/feat_harness_init_notification_topic_prompt_task_prompt.md → `### Run mode`
- skipped: qa
