# Flow progress — fix_observations_repo_relative_paths   (engine: task)

## Run mode
Source: harness-runs/task_prompts/fix_observations_repo_relative_paths_task_prompt.md → `### Run mode`
- skipped: none
