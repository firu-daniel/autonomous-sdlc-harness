 ...
 * ships opt-in, measured once against agent navigation on a real 1,960-chunk catalog with the outcome
 * *withdrawn* (`docs/retrieval-eval-results.md` → `## The decision, applied to the real catalog`), and
 * this file is what distinguishes a tool no agent reaches for from one agents reach for and get nothing from. A
